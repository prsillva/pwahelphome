...
const preencherFormulario2 = (endereco2) =>{
    document.getElementById('id_street').value = endereco2.logradouro;
    document.getElementById('id_district').value = endereco2.bairro;
    document.getElementById('id_city').value = endereco2.localidade;
    document.getElementById('id_state').value = endereco2.uf;
}
...
const pesquisarCep = async() => {
    ...
    const cep2 = document.getElementById('id_zip_code').value;
    ...
    if (cepValido2(cep2)){
        ...
        if (endereco2.hasOwnProperty('erro')){
            document.getElementById('id_street').value = 'CEP não encontrado!';
        }else {
            preencherFormulario2(endereco2);
        }
    }else{
        document.getElementById('id_street').value = 'CEP incorreto!';
    }
     
}

document.getElementById('id_zip_code')
